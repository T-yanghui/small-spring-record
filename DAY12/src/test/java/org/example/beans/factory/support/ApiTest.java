...
import org.example.aop.framework.adapter.MethodBeforeAdviceInterceptor;
import org.example.beans.factory.support.beans.IUserService;
import org.example.beans.factory.support.beans.UserService;
import org.example.beans.factory.support.beans.UserServiceBeforeAdvice;
import org.example.beans.factory.support.beans.UserServiceInterceptor;
...
public class ApiTest {
    ...
    public void test_proxy_method() {
        ...
        IUserService proxy = (IUserService) Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), targetObj.getClass().getInterfaces(), new InvocationHandler() {
            // 方法匹配器
            MethodMatcher methodMatcher = new AspectJExpressionPointcut("execution(* org.example.beans.factory.support.beans.IUserService.*(..))");
